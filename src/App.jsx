...
import Waiting from './features/References/Waiting';
    ...
    <div>
      ...
      {hasAccess && (
        <nav>
          ...
          {user && <NavLink to="/W" className={({ isActive }) => isActive ? styles.active : styles.link}>הזמנות</NavLink>}
        ...
        <Routes>
          ...
          {/* כל שאר הדפים זמינים רק אחרי לחיצה */}
            ...
            <>
              ...
              <Route path="/W" element={<Waiting searchS={""} />} />
